    ...
    public static class PadeyeBasicChecker
    {
        public static PadeyeBasicCheckResult Check(PadeyeBasicCheckInput input)
        {
            ...
            double requiredHoleDiameter_mm =
                input.LugType == LugType.TransportLug
            ...
            if (input.LugType == LugType.TransportLug)
            {
                ...
                result.ThicknessUtilization = requiredThickness_mm / input.PlateThickness_mm;
            }
            else
            {
                result.WllOk = true;
                result.WllUtilization = 0.0;
                result.HoleDiameterOk = true;
                result.HoleDiameterUtilization = 0.0;
                result.ThicknessOk = true;
                result.ThicknessUtilization = 0.0;
            }
